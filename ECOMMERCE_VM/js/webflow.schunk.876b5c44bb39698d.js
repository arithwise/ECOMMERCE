				...
				function R(t, i, a) {
					return function(r) {
						if (i) t.hasFocus[a] = i;
							...
							if (t.hasFocus[a] = i, t.hasFocus.mouse && "keyboard" === a || t.hasFocus.keyboard && "mouse" === a) return
						}
				...
				function O(i) {
					return function(r, s) {
						...
						if (o && "setting" === r.type) {
							...
							return d = i, l = s.select, f = null, l === d.slides.length && (g(), M(d)), t.each(d.anchors, function(t, i) {
						...
						if ("swipe" === r.type) return u.disableSwipe || a.env("editor") ? void 0 : "left" === s.direction ? A(i)() : "right" === s.direction ? W(i)() : void 0;
